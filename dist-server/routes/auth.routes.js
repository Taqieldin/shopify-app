 ...
 */
authRouter.get('/shopify', (req, res) => {
    if (!SHOPIFY_API_KEY) {
    ...
    const installUrl = `https://${sanitizedShop}/admin/oauth/authorize?client_id=${SHOPIFY_API_KEY}&scope=${SCOPES}&redirect_uri=${encodeURIComponent(redirectUri)}&state=${state}`;
