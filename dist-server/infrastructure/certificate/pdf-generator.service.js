...
export class PDFGeneratorService {
     ...
     */
    static async generatePDFCertificate(certData, options) {
     ...
     */
    static async generatePDFFromSerial(shopId, serial, options) {
     ...
     */
    static async generateBatchPDFs(shopId, serials, options) {
     ...
     */
    static async generatePDFWithPDFKit(certData) {
