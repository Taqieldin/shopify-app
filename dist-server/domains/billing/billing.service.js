...
export class BillingService {
     ...
     */
    static async getSubscriptionStatus(shop_id) {
        ...
        const activePlanName = shop?.plan || 'FREE';
        ...
        return {
            ...
            usage: {
                ...
                utilization_percent: Math.min(100, Math.round((serialsCount / (PRICING_PLANS[activePlanName]?.max_serials || 25)) * 100)),
            },
     ...
     */
    static async changePlan(shop_id, targetPlan, actor_id) {
