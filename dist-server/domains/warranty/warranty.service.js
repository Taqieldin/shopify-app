...
export class WarrantyService {
     ...
     */
    static async createWarranty(shop_id, dto, actor_id) {
     ...
     */
    static async getWarrantyBySerial(shop_id, serial) {
        const piece = await prisma.physicalPiece.findUnique({
     ...
     */
    static async listWarranties(shop_id, options = {}) {
     ...
     */
    static async extendWarranty(shop_id, warranty_id, additional_years, actor_id) {
