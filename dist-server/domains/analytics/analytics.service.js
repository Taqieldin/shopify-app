...
export class AnalyticsService {
     ...
     */
    static async getDashboardMetrics(shop_id) {
        const [totalPieces, registeredPieces, totalPassports, authEventsCount, riskEventsCount, activeMembersCount, creditsAggregate, transfersCount, servicesCount, stolenCount,] = await Promise.all([
