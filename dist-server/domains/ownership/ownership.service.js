...
export class OwnershipService {
     ...
     */
    static async registerPiece(shop_id, dto, actor_id) {
     ...
     */
    static async getCustomerCollection(shop_id, customer_shopify_id) {
     ...
     */
    static async getPieceProvenance(shop_id, serial) {
        const piece = await prisma.physicalPiece.findUnique({
            where: {
                shop_id_serial: {
                    shop_id,
