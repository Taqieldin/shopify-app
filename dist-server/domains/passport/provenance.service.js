...
export class ProvenanceService {
     ...
     */
    static async getTimeline(shopId, serial, includePrivate = false) {
        ...
        if (piece.lost_reports.some((r) => r.status === 'CONFIRMED')) {
