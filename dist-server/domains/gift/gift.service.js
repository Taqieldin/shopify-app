...
export class GiftService {
     ...
     */
    static async createGift(shop_id, dto) {
     ...
     */
    static async getGiftByClaimCode(shop_id, claim_code) {
     ...
     */
    static async claimGift(shop_id, dto) {
        const gift = await prisma.giftRegistration.findUnique({
        ...
        await CreditsService.postTransaction(shop_id, {
