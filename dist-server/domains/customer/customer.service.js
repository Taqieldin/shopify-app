...
export class CustomerService {
     ...
     */
    static async getOrCreateProfile(shop_id, shopify_customer_id, email, first_name, last_name) {
     ...
     */
    static async getCollectorVault(shop_id, shopify_customer_id) {
     ...
     */
    static async requestAtelierCare(shop_id, shopify_customer_id, dto) {
        const customer = await prisma.customer.findUnique({
            where: {
                shop_id_shopify_customer_id: { shop_id, shopify_customer_id },
            },
        ...
        return CareService.createServiceCase(shop_id, {
            serial: dto.serial,
     ...
     */
    static async updateCommunicationPreferences(shop_id, shopify_customer_id, dto) {
        const customer = await prisma.customer.findUnique({
            where: {
                shop_id_shopify_customer_id: { shop_id, shopify_customer_id },
            },
