...
export class CertificateGenerator {
   ...
   */
  static generateVerificationHash(metadata: CertificateMetadata, salt = 'atelier_provenance_2026'): string {
   ...
   */
  static generatePrintableHTML(metadata: CertificateMetadata): string {
