 ...
 */
webhookRouter.post('/app-uninstalled', async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
webhookRouter.post('/orders', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const shopDomain = req.headers['x-shopify-shop-domain'] as string;
 ...
 */
webhookRouter.post('/products', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const shopDomain = req.headers['x-shopify-shop-domain'] as string;
