...
export class PIIFilterService {
   ...
   */
  static filterPublicPassportData(data: any): any {
    const allowedFields = [
      'serial',
      'product_title',
      'edition',
   ...
   */
  static filterPublicOwnershipData(data: any): any {
    const filtered = { ...data };
   ...
   */
  static filterPublicAuthenticationData(data: any): any {
    const filtered = { ...data };
   ...
   */
  static filterPublicServiceData(data: any): any {
    return {
      id: data.id,
   ...
   */
  static filterPublicProvenanceEvents(events: any[]): any[] {
   ...
   */
  private static sanitizeDescription(text: string): string {
   ...
   */
  private static filterObject(obj: any, allowedFields: string[]): any {
   ...
   */
  static detectPII(data: any): { hasPII: boolean; fields: string[] } {
   ...
   */
  static createPublicResponse(data: any, config?: PIIFilterConfig): any {
 ...
 */
export function piiFilterMiddleware(req: any, res: any, next: any) {
