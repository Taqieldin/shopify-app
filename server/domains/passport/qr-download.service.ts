...
export class QRDownloadService {
   ...
   */
  static async generatePNG(shopId: string, serial: string, options?: {
    baseUrl?: string;
    width?: number;
  }): Promise<Buffer> {
   ...
   */
  static async generateSVG(shopId: string, serial: string, options?: {
    baseUrl?: string;
    width?: number;
  }): Promise<string> {
    const piece = await prisma.physicalPiece.findUnique({
   ...
   */
  static async generateDataURL(shopId: string, serial: string, options?: {
    baseUrl?: string;
    width?: number;
  }): Promise<string> {
    const piece = await prisma.physicalPiece.findUnique({
   ...
   */
  static async generateBatch(shopId: string, serials: string[], options?: {
    baseUrl?: string;
    width?: number;
