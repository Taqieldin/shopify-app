...
export interface CheckInDTO {
  event_id: string;
  customer_shopify_customer_id: string;
...
export class ClubEventService {
   ...
   */
  static async createEvent(shop_id: string, dto: CreateEventDTO, actorId: string) {
   ...
   */
  static async listEvents(shop_id: string) {
   ...
   */
  static async setStatus(shop_id: string, event_id: string, status: EventStatus, actorId: string) {
   ...
   */
  static async checkIn(shop_id: string, dto: CheckInDTO) {
    const event = await prisma.clubEvent.findFirst({
    ...
    const creditEntry = await CreditsService.postTransaction(
      shop_id,
      {
   ...
   */
  static async getMemberEvents(shop_id: string, customer_shopify_customer_id: string) {
