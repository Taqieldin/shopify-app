...
export interface UpsertTierDTO {
  id?: string;
  tier_level: number;
  name: string;
  code: string;
...
export class MembershipService {
   ...
   */
  static async getTiers(shop_id: string) {
   ...
   */
  static async upsertTier(shop_id: string, dto: UpsertTierDTO, actor_id: string) {
    const tier = dto.id
   ...
   */
  static async getCustomerMembership(shop_id: string, customer_shopify_id: string) {
